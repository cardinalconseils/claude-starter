...
| `learnings-curator.md` | Daily pass over a source repo — new material becomes validated, agent-attributed learnings; opens a PR, never pushes to main |
| `project-manager.md` | Turns dispatched work into GitHub Issues so every task is on the kanban board with owner, description and state; reconciles drift |
