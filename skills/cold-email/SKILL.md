---
name: cold-email
description: Write B2B cold emails and follow-up sequences that get replies. Use when the user wants to write cold outreach emails, prospecting emails, cold email campaigns, sales development emails, or SDR sequences.
...
Subject lines determine open rate. They should be:
- Specific (not clever)
- Under 50 characters
...
**Avoid:**
- "Following up" (overused, signals a previous cold email chain)
- "Checking in"
- ALL CAPS
- Clickbait subject lines that don't match the body
...
**Tier 3 — Industry-specific (lower effort, lower reply rate but scalable):**
...
Test: Can your prospect explain what you do to their colleague after reading this one sentence? If not, simplify.
...
Match the proof point to the prospect's likely concern. For early-stage prospects: speed of results. For enterprise: risk reduction and security. For volume-sensitive: scale and reliability.

## CTA Design

One ask. Specific. Low friction.

**Best CTAs for cold email:**
...
**CTA principles:**
- Yes/No questions outperform open-ended questions ("Would you be interested?" vs "Let's connect")
...
Most replies come from follow-ups, not the first email. But each follow-up must add value, not just nag.
...
True 1:1 personalization doesn't scale. Use a tiered personalization model:
...
**Tier 3 (60% of list):** Segment personalization. One version per segment (industry, role, company size). Opening line references their segment, not their name.

**Signal sources for personalization:**
...
- G2 reviews (see what their customers say — mirrors their selling language)
- Recent news mentions

## Deliverability: Technical Foundation

A great email that lands in spam is worthless.
...
- Use warm-up tools: Lemwarm, Warmbox, Mailreach
...
| "Our product is complex — we need to explain it fully in email 1" | Nobody reads a wall of text from a stranger. You earn the right to explain more on a call. |
...
| "Deliverability is IT's problem" | Landing in spam = 0% deliverability. Sending domain setup is a marketing responsibility. |
