# Verification Guardrail Catalog
...
Write the following to `.claude/rules/verification.md`:
...
- No `globs:` frontmatter needed — applies before every "done" claim and git commit
- References `PROJECT.md` for maturity stage — bootstrapped projects will have this file
