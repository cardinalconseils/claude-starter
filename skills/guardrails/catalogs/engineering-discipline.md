# Engineering Discipline Guardrail Catalog
...
Write the following to `.claude/rules/engineering-discipline.md`:
...
- No `globs:` frontmatter needed — these rules govern every code change regardless of file type
