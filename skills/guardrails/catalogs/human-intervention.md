# Human Intervention Guardrail Catalog
...
Write the following to `.claude/rules/human-intervention.md`:
...
- Defines the three mandatory block formats: ACTION REQUIRED, DECISION REQUIRED, SUGGESTION
