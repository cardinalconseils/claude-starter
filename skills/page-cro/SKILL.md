...
- **Google Analytics / GA4:** Funnel visualization, scroll depth, device breakdown, traffic source by conversion rate
- **Heatmaps:** Click maps (what do people click?), scroll maps (how far do people scroll?), move maps
- **Session recordings:** Watch real users navigate — Hotjar, FullStory, Microsoft Clarity (free)
- **Form analytics:** Which form fields cause drop-off? (Hotjar forms, Formisimo)
...
- [ ] Fast-loading (< 200kb for images, preloaded for video)
...
**Run 2-3 headline variants in an A/B test before committing.**
...
| Autoplay video | Give user control; don't force attention |
...
**CTA design rules:**
- High contrast against background (not your brand's subtle secondary color)
- Large enough to tap easily on mobile (44px minimum touch target)
- Generous padding (not a tiny button)
- One primary CTA per section (secondary CTAs can exist but must be visually subdominant)

## Social Proof Types and Placement

Different social proof works at different stages of the page:

| Position | Best proof type |
|---|---|
| Hero section | Customer count, logo bar, review rating |
| Problem section | Quote acknowledging the pain ("We were stuck in spreadsheets until...") |
...
**Collect strong testimonials actively.** Ask customers: "Can you describe a specific result you got from using [product]?"

## Pricing Page Optimization

The pricing page is often the highest-impact CRO opportunity.

**Pricing page elements:**
- [ ] Clear tier names (not just Basic/Pro/Enterprise — use outcome-oriented names)
- [ ] Recommended plan highlighted (increases average order value)
- [ ] Annual/monthly toggle with annual discount shown
- [ ] Feature list long enough to justify price, short enough to read
- [ ] FAQ section addressing pricing objections
- [ ] Social proof specific to pricing ("Plans that fit teams of all sizes")
...
- Or: highlight the middle/recommended tier prominently to anchor selection

## Mobile CRO

Mobile visitors convert at ~50% the rate of desktop visitors for most B2B products. Fix the mobile experience before driving more mobile traffic.

**Mobile audit:**
- [ ] Hero above-fold visible without scrolling on smallest target device (iPhone SE)
...
- High clicks on secondary elements → they may be more important than primary
- Low clicks on CTA → visibility, copy, or placement problem

**Scroll maps — what to look for:**
- Drop-off at a specific element → something is either confusing or repelling people
...
- Form abandonment at specific field → that field is asking for something unwilling to give
...
| "We tested it once and saw no difference" | Underpowered tests produce noise. Calculate required sample size before running. |
