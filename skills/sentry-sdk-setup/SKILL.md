...
description: >
  ...
  Use when: asked to add Sentry, install Sentry SDK, set up error monitoring, configure
  error tracking, add observability, or integrate Sentry into a project.
allowed-tools: Read, Write, Edit, Bash, Glob, Grep, WebFetch
license: Apache-2.0
source: https://github.com/getsentry/sentry-for-ai/blob/main/skills/sentry-sdk-setup/SKILL.md
role: router
---

> Source: [getsentry/sentry-for-ai](https://github.com/getsentry/sentry-for-ai/blob/main/skills/sentry-sdk-setup/SKILL.md) — Apache-2.0
...
Match your project to a skill by keywords. Fetch with: `curl -sL https://skills.sentry.dev/{path}`
...
| react-router framework, @sentry/react-router, @react-router/dev | `sentry-react-router-framework-sdk/SKILL.md` |
| tanstack start, @tanstack/react-start | `sentry-tanstack-start-sdk/SKILL.md` |
