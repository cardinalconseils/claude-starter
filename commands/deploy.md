...
```
Agent(subagent_type="cks:shipper", prompt="Deploy the project. Read .prd/PRD-STATE.md for context. Validate environment variables, run the build, trigger deployment, and confirm health. Args: $ARGUMENTS")
```
