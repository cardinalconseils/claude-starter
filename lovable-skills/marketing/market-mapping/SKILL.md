...
1. Identify every role in the value chain (supplier → builder → distributor → customer success → end user)
2. Estimate gross margin at each stage (use public comps, 10-K filings, or proxy signals)
3. Find the stage where margin concentrates — that's where bargaining power lives
4. Distinguish: who creates value vs who extracts value
...
White space must be specific enough to build a product thesis against: "Agencies with 5-20 employees who manage paid social for e-commerce clients — no one has built a reporting tool specifically for this workflow."

## Output Structure

Every market map delivers:

1. **Market map** — 3-5 player categories with brief characterization (model + optimization vector)
2. **Competitive moves to watch** — the 1-2 strongest players' next likely moves
3. **Target segment** — defined by pain + WTP + reachability, not just size
4. **Profit concentration** — where in the value chain margin sits and why
5. **White space** — the specific gap, specific enough to anchor a product thesis

## Research Process

**Step 1:** List every player you know in the space (10-20 companies). Don't filter yet.

**Step 2:** Research each: What is their business model? Who is their primary customer? What do they charge? What do their best customers love? What do churned customers complain about?

**Step 3:** Group into tiers (Incumbent / Challenger / Adjacent / Emerging).

**Step 4:** For each tier, name the #1 company and describe what they optimize for.

**Step 5:** Apply the profit pool analysis to the value chain.

**Step 6:** Apply the 3-axis segmentation to identify target customers.

**Step 7:** Name the white space with enough specificity to build against it.

**Sources:** Company websites, G2/Capterra reviews (read the negative reviews), LinkedIn job postings (reveals priorities), Crunchbase (funding signals), public revenue data or S-1 filings for public companies.
...
| "All segments look attractive" | Apply the pain × WTP × reachability filter. If multiple segments still look equal, you need more data on one of the three axes. |
...
- [ ] Player categories describe behavior and business model, not just company names
- [ ] Profit pool is distinct from revenue map — margin concentration identified
- [ ] Target segment defined by pain + WTP + reachability, not demographics alone
- [ ] White space is specific enough to build a product thesis against it
