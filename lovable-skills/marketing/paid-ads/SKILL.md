...
Always build a negative keyword list before launch. Common negatives: "free," "jobs," "salary," "DIY," competitor brand names you don't want to target. Review Search Terms report weekly for new negatives.
...
For B2B with longer buying cycles: Use 7-day click only (removes view-through inflation). Supplement with Conversions API (server-side) for accuracy.

## LinkedIn Ads

### When to Use LinkedIn

LinkedIn is expensive (CPCs of $8-15) but offers unique targeting:
...
**LinkedIn Lead Gen Forms** pre-populate from the user's LinkedIn profile, increasing conversion rates 2-5× vs landing page traffic. Keep form to 3-4 fields maximum.
...
**Last-click:** All credit to the last touchpoint. Undervalues top-of-funnel channels.
**Data-driven:** Google distributes credit based on observed path patterns. Requires 300+ conversions/month.
**Linear:** Equal credit across all touchpoints. Safe default when you can't run data-driven.

**For B2B:** Use data-driven if you have > 300 conversions/month; otherwise linear.
...
| "LinkedIn is too expensive for our budget" | LinkedIn is only too expensive if LTV doesn't support the CAC. |
...
- [ ] Weekly optimization cadence defined (what to review, when)
